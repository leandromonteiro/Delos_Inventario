...
Public Class Inventário_Excel
    Dim connstr As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Public\INVENTÁRIO_BD.xlsx;Extended Properties='Excel 12.0 Xml;HDR=YES';"
    Dim connstr_consulta As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & My.Settings.DataSource & ";Extended Properties='Excel 12.0 Xml;HDR=YES';"
    ...
    Public Function Consulta_TI_Geral(TI As Integer)
        Try
            ...
            cmd.CommandText = "select Desc_Geral from [TI$] where Cod_Geral=" & _
    ...
    Public Sub Buscar_Fotos()
        Try
            ...
            Dim connection As New OleDb.OleDbConnection(connstr)
            connection.Open()
            DA.SelectCommand = New OleDb.OleDbCommand("select [FOTOS],[CAMINHO FOTOS] from [ADM$];", connection)
            DA.Fill(DS, "TB_Foto")
            connection.Close()
    ...
    Public Sub Update_Inventario(ID As Integer, seq As String, local As String, odi As String, cod_ti As String, ti As String, bay As String,
        ...
        Try
            ...
            connection.Open()
            cmd.Connection = connection
            cmd.CommandText = "update [Inventario$] set [Sequencial]='" & seq & "',[Local]='" & local & "',[ODI]='" & odi & "',[Código TI]='" & _
                cod_ti & "',[TI]='" & ti & "',[Bay]='" & bay & "',[Código TUC]='" & cod_tuc & "',[Descrição TUC]='" & tuc & "',[Código Tipo de Bem]='" & _
                cod_tipo_bem & "',[Descrição Tipo de Bem]='" & tipo_bem & "',[Código UAR]='" & cod_uar & "',[Descrição UAR]='" & uar & _
                "',[Código A2]='" & cod_a2 & "',[Descrição A2]='" & a2 & "',[Código A3]='" & cod_a3 & "',[Descrição A3]='" & a3 & "',[Código A4]='" & _
                cod_a4 & "',[Descrição A4]='" & a4 & "',[Código A5]='" & cod_a5 & "',[Descrição A5]='" & a5 & "',[Código A6]='" & cod_a6 & _
                "',[Descrição A6]='" & a6 & "',[Código CM1]='" & cod_cm1 & "',[Descrição CM1]='" & cm1 & "',[Código CM2]='" & cod_cm2 & _
                "',[Descrição CM2]='" & cm2 & "',[Código CM3]='" & cod_cm3 & "',[Descrição CM3]='" & cm3 & "',[Descrição]='" & descricao & _
                "',[Fabricante]='" & fabricante & "',[Modelo]='" & modelo & "',[N° de Série]='" & serie & "',[Observação]='" & obs & "',[Quantidade]=" & _
                qtd & ",[Unidade de Medida]='" & um & "',[Ano de Fabricação]='" & ano & "',[Mês de Fabricação]='" & mes & "',[Dia de Fabricação]='" & dia & _
                "',[Status do Bem]='" & status & "',[Estado do Bem]='" & estado_bem & "',[Altura]=" & altura & ",[Largura]=" & largura & ",[Comprimento]=" & _
                comprimento & ",[Área]=" & area & ",[Pé Direito]=" & pe & ",[Observacao Civil]='" & obs_civil & "',[Consultor]='" & consultor & "',[Líder]='" & _
    ...
    Public Sub Consulta_Excel(DGV As DataGridView)
        Try
            ...
            connection.Open()
            DA.SelectCommand = New OleDb.OleDbCommand("select * from [Inventario$];", connection)
            DA.Fill(DT)
            connection.Close()
            DGV.DataSource = DT
        Catch
